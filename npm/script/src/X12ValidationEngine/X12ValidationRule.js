...
const X12ValidationErrorCode_js_1 = require("./X12ValidationErrorCode.js");
class X12ValidationRule {
    constructor(options) {
        ...
        Object.defineProperty(this, "ruleType", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        });
        Object.defineProperty(this, "failureCode", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        if (typeof options.engine === "string" &&
            options.engine.toLowerCase() !== "rule") {
    ...
    assert(value, position) {
        ...
        if (this.engine instanceof RegExp) {
            if (!this.engine.test(`${value}`)) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, this.failureCode, position, value));
            }
        }
...
class X12InterchangeRule extends X12ValidationRule {
    constructor(options) {
        ...
        if (options.header instanceof X12SegmentRule ||
        ...
        if (options.trailer instanceof X12SegmentRule ||
            typeof options.trailer === "object") {
    ...
    assert(group, controlNumber) {
        ...
        if (headerResult !== true) {
            ...
            if (typeof groupIdResult === "object") {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "1", controlNumber));
            }
            if (typeof groupNumberResult === "object") {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "6", controlNumber));
            }
        }
        ...
        if (trailerResult === true) {
            ...
            if (trailerControlNumber !== controlNumber) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "4", controlNumber));
            }
            if (transactionCount !== group.transactions.length) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "5", controlNumber));
            }
        }
...
class X12TransactionRule extends X12ValidationRule {
    ...
    assert(transaction, controlNumber) {
        ...
        const handleLoop = function handleLoop(index, ruleIndex) {
            ...
            return _this.segments[ruleIndex].loopStart
                ? handleLoop(index, ruleIndex)
                : { index, ruleIndex };
        };
        ...
        if (headerResult !== true) {
            ...
            if (typeof transactionNumberResult === "object") {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "7", controlNumber));
            }
        }
            ...
            if (typeof this.segments[ri] === "undefined") {
                segmentReports.push({
                    segment: {
                        ...
                        position: i,
                        errors: [(0, X12ValidationErrorCode_js_1.errorLookup)("segment", "2", i)],
                    },
                });
                continue;
            }
        ...
        if (trailerResult === true) {
            ...
            if (trailerControlNumber !== controlNumber) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "3", controlNumber));
            }
...
class X12SegmentRule extends X12ValidationRule {
    constructor(options) {
        ...
        this.elements = typeof options.elements === "string"
            ? options.elements
    ...
    assert(segment, position = 1) {
        ...
        if (segment.tag !== this.tag) {
            errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "2", position));
            if (this.mandatory) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "3", position));
            }
        }
        if (typeof this.elements !== "string" && Array.isArray(this.elements)) {
            ...
            if (segment.elements.length > this.elements.length) {
                elements.push((0, X12ValidationErrorCode_js_1.errorLookup)("element", "3", position));
            }
            if (elements.length > 0) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "8", position));
            }
        }
        return (errors.length === 0 || {
            segment: {
...
class X12ElementRule extends X12ValidationRule {
    constructor(options) {
        ...
        Object.defineProperty(this, "allowBlank", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
        ...
        Object.defineProperty(this, "padLength", {
            enumerable: true,
            configurable: true,
            writable: true,
            value: void 0
    ...
    assert(element, position) {
        ...
        if (typeof element === "undefined") {
            return { elements: [(0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "2", position, "")] };
        }
        ...
        const isGreaterThanMax = function isGreaterThanMax(val) {
            return ((typeof _this.maxLength === "number" && val.length > _this.maxLength) ||
        ...
        if (this.engine instanceof RegExp) {
            ...
            if (typeof this.expect === "string") {
                if (value.toString().trim() === this.expect.trim()) {
                    ...
                    errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "2", position, value));
                }
            }
            if (value.toString().trim() === "") {
                if (this.allowBlank)
                    return true;
                if (this.mandatory) {
                    errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "1", position, value));
                }
                else {
                    return true;
                }
            ...
            if (isLessThanMin(value)) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "4", position, value));
            }
            if (isGreaterThanMax(value)) {
                errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "5", position, value));
            }
            if (typeof this.checkType === "string") {
                ...
                switch (this.checkType) {
                    case "number":
                        if (!N0.test(value)) {
                            errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "6", position, value));
                        }
                        break;
                    case "decimal":
                        if (!R.test(value)) {
                    ...
                    case "gs01":
                        if (!GS01.test(value)) {
                            errors.push((0, X12ValidationErrorCode_js_1.errorLookup)(this.ruleType, "7", position, value));
                        }
                        break;
                    case "st01":
                        if (!ST01.test(value)) {
