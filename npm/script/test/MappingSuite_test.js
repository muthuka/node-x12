...
(0, mod_js_1.describe)("X12Mapping", () => {
    ...
    (0, mod_js_1.it)("should generate LQ segments from nested arrays using repeatFor with LiquidJS", () => {
        const transaction = new mod_js_2.X12Transaction();
        const adjustmentMap = {
        ...
        const mapper = new mod_js_2.X12TransactionMap(adjustmentMap, transaction, "liquidjs");
        const inputData = {
            adjustments: [
                {
                    groupCode: "PI",
        ...
        assert.strictEqual(result instanceof mod_js_2.X12Transaction, true);
