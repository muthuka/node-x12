...
export declare type Func<T = unknown> = (this: T, t: dntShim.Deno.TestContext) => void | PromiseLike<void>;
export declare type Hook<T> = HookFunc<T> | HookFunc<T>[];
export declare type HookFunc<T> = (this: T) => void | Promise<void>;
export declare type HookName = "beforeAll" | "afterAll" | "beforeEach" | "afterEach";
