...
import { JSEDINotation, X12FatInterchange, X12Interchange, X12Parser, X12Segment, } from "../mod.js";
import { JSEDIFunctionalGroup, JSEDITransaction, } from "../src/JSEDINotation.js";
...
describe("X12ObjectModel", () => {
    ...
    it("should construct JSEDINotation objects", () => {
        ...
        if (!(notation instanceof JSEDINotation) ||
